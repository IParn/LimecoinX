...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a LimecoinX address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About LimecoinX"), this);
    aboutAction->setToolTip(tr("Show information about LimecoinX"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for LimecoinX"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("LimecoinX client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid LimecoinX address or malformed URI parameters."));
    }
