...
QT_TRANSLATE_NOOP("bitcoin-core", "limecoin version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of limecoin"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the limecoin Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: limecoin.conf)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart limecoin to complete"),
